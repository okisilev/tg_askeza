#!/usr/bin/env python3
"""
Тестовый скрипт для проверки доступа к новому каналу
...
async def test_new_channel_access():
    """Тест доступа к новому каналу"""
    print("📺 Тестирование доступа к каналу 'Аскеза✨ Верь в себя!'")
...
async def test_user_access_to_new_channel(user_id: int):
    """Тест доступа пользователя к новому каналу"""
    print(f"\n👤 Тестирование доступа пользователя {user_id} к новому каналу")
    print("=" * 50)
...
def print_setup_instructions():
    ...
    print("\n" + "=" * 50)
    print("🔧 ИНСТРУКЦИИ ПО НАСТРОЙКЕ НОВОГО КАНАЛА")
    print("=" * 50)
    
    print("\n1️⃣ Настройте переменные окружения:")
    print("   • BOT_TOKEN - токен бота")
    print("   • PRIVATE_CHANNEL_ID=-2073129707770")
    print("   • PRIVATE_CHAT_ID - ID чата (не настроен)")
    
    print("\n2️⃣ Добавьте бота в канал 'Аскеза✨ Верь в себя!':")
    ...
    print("\n5️⃣ Для supergroup:")
    print("   • Убедитесь, что бот имеет права администратора")
    print("   • Проверьте права на добавление участников")
    print("   • Убедитесь, что канал не заблокирован")

async def main():
    """Основная функция"""
    user_id = 431292182  # Тестовый пользователь из логов
    
    print("🧪 Тестирование доступа к новому каналу 'Аскеза✨ Верь в себя!'")
    print("ID=-2073129707770, Type=supergroup")
    print("=" * 50)
    
    # Тестируем настройки канала
    channel_ok = await test_new_channel_access()
    ...
    access_ok = await test_user_access_to_new_channel(user_id)
    ...
    print("\n📋 Рекомендации:")
    print("1. Убедитесь, что бот является администратором канала 'Аскеза✨ Верь в себя!'")
    print("2. Проверьте, что у бота есть права на приглашение")
    print("3. Запустите бота и протестируйте кнопку 'Закрытый канал'")
    print("4. Убедитесь, что канал существует и доступен")
